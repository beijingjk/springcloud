...
/** 
 * <pre>项目名称：springboot    
 * 类名称：AliyunOSSClientUtil    
 * 类描述：    
 * 创建人：薛长欢
 * 创建时间：2018年9月11日 下午3:56:32    
 * 修改人：   
 * 修改时间：2018年9月11日 下午3:56:32    
 * 修改备注：       
 * @version </pre>    
 */
public class AliyunOSSClientUtil {
    ...
    public static  String uploadObject2OSS(OSSClient ossClient, File file, String bucketName, String folder) {
        ...
        try {
            ...
            URL url = ossClient.generatePresignedUrl(bucketName, folder + fileName, date);
