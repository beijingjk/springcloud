...
public class UserServiceImpl implements UserServiceApi {
    ...
    public void saveFruits(FruitsInfo fruitsInfo) {
        ...
        String img1 = fruitsInfo.getImg1();
        String[] split = img1.split(",");
        fruitsInfo.setImg1(split[0]);
        fruitsInfo.setImg2(split[1]);
        fruitsInfo.setImg3(split[2]);
        fruitsInfo.setImg4(split[3]);
        userMapper.saveImgs(fruitsInfo);
    }
